...
import (
	...
	"github.com/lomocoin/stellar-go/services/horizon/internal/txsub/sequence"
...
func TestTransactionActions_Index(t *testing.T) {
	...
	// regression: https://github.com/lomocoin/stellar-go/services/horizon/internal/issues/365
