...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
PACKAGES=$(find $GOTOP/src/github.com/lomocoin/stellar-go/services/horizon/internal/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find $GOTOP/src/github.com/lomocoin/stellar-go/services/horizon/internal/test/scenarios -iname 'kahuna.rb')

go install github.com/lomocoin/stellar-go/services/horizon
...
go generate github.com/lomocoin/stellar-go/services/horizon/internal/test/scenarios
# go test github.com/lomocoin/stellar-go/services/horizon/internal/ingest
