...
[Prebuilt binaries](https://github.com/lomocoin/stellar-go/releases) of the federation server are available on the [releases page](https://github.com/lomocoin/stellar-go/releases).
...
```
go get -u github.com/lomocoin/stellar-go/services/federation
```
